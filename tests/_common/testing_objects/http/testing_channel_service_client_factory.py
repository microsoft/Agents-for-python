...
from .testing_connector_client import TestingConnectorClient


class TestingRestChannelServiceClientFactory(ChannelServiceClientFactoryBase):
    ...
    def __init__(
        ...
        connector_client_class: type[BaseConnectorClient] = TestingConnectorClient,
        user_token_client_class: type[BaseUserTokenClient] = TestingUserTokenClient,
    ) -> None:
        self._mocker = mocker
        self._connection_manager = connection_manager
        self._token_service_endpoint = token_service_endpoint
        self._token_service_audience = token_service_audience
        self._connector_client_class = connector_client_class
        self._user_token_client_class = user_token_client_class
    ...
    async def create_connector_client(
        ...
        return self._connector_client_class(
    ...
    async def create_user_token_client(
        ...
        return self._user_token_client_class(
