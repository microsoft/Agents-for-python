...
from microsoft_agents.hosting.core.authorization import ClaimsIdentity, JwtTokenValidator
...
def app_with_middleware():
    ...
    async def test_endpoint(request: Request):
        ...
        return {
            "authenticated": claims_identity.is_authenticated if claims_identity else False,
...
class TestJwtAuthorizationMiddleware:
    ...
    def test_anonymous_claims_without_await(self, app_with_middleware, auth_config_anonymous):
        """
    ...
    def test_missing_auth_header_with_client_id_returns_401(self, app_with_middleware, auth_config_with_client_id):
        """
    ...
    def test_invalid_auth_header_format_returns_401(self, app_with_middleware, auth_config_with_client_id):
        """
    ...
    def test_valid_token_sets_claims_identity(self, app_with_middleware, auth_config_with_client_id):
        """
        ...
        with patch.object(JwtTokenValidator, 'validate_token', new_callable=AsyncMock) as mock_validate:
    ...
    def test_invalid_token_returns_401(self, app_with_middleware, auth_config_with_client_id):
        """
