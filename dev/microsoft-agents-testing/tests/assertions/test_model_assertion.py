...
class TestModelAssertionCheckWithQuantifierAll:
    ...
    def test_check_all_with_one_failing_activity(self, activities):
        ...
        assert "Item did not match the assertion" in error
...
class TestModelAssertionCheckWithQuantifierNone:
    ...
    def test_check_none_with_one_match(self, activities):
        ...
        assert passes is False
        assert error is not None
        assert "Item matched the assertion when none were expected" in error
...
class TestModelAssertionCheckWithQuantifierOne:
    ...
    def test_check_one_with_no_matches(self, activities):
        ...
        assert passes is False
        assert error is not None
        assert "Expected exactly one item" in error
...
class TestModelAssertionCheckWithQuantifierAny:
...
class TestModelAssertionFromConfig:
...
class TestModelAssertionCombineErrors:
    ...
    def test_combine_single_error(self):
        ...
        result = ModelAssertion._combine_assertion_errors([error])
    ...
    def test_combine_multiple_errors(self):
        ...
        result = ModelAssertion._combine_assertion_errors(errors)
        assert "activity.text" in result
        assert "activity.type" in result
        assert "\n" in result


class TestModelAssertionIntegration:
...
class TestModelAssertionEdgeCases:
    ...
    def test_empty_assertion_matches_all(self):
        ...
        assertion = ModelAssertion(assertion={}, quantifier=AssertionQuantifier.ALL)
        passes, error = assertion.check(activities)
        assert passes is True
...
class TestModelAssertionErrorMessages:
...
class TestModelAssertionRealWorldScenarios:
