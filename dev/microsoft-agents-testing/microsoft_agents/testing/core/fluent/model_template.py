...
class ModelTemplate(Generic[ModelT]):
    ...
    def __init__(
        self, model_class: type[ModelT], defaults: ModelT | dict | None = None, **kwargs
    ) -> None:
    ...
    def with_updates(
        self, updates: dict | None = None, **kwargs
    ) -> ModelTemplate[ModelT]:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and self._model_class == other._model_class
        )
