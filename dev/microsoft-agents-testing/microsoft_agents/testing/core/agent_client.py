...
from .transport import Transcript, Exchange, Sender
...
class AgentClient:
    ...
    def __init__(
        ...
        self._template = (template or ActivityTemplate()).with_defaults(
            _DEFAULT_ACTIVITY_FIELDS
        )
    ...
    async def ex_send(
        ...
        **kwargs,
        ...
        exchange = await self._sender.send(
            activity, transcript=self._transcript, **kwargs
        )
    ...
    async def send_stream(
        ...
        **kwargs,
        ...
        :return: A list of reply Activities.
        """
        return activities_from_ex(await self.ex_send_stream(activity_or_text, **kwargs))
    ...
    def child(self) -> AgentClient:
        ...
        """
        return AgentClient(
            self._sender, transcript=self._transcript.child(), template=self._template
        )
