...
def copy_with_defaults(original: dict, defaults: dict) -> dict:
    """Create a copy of a dictionary populated with default values.

    :param original: The original dictionary to populate.
    :param defaults: The dictionary containing default values.
    :return: A new dictionary populated with default values.
    """
