...
class Executor(ABC):
    ...
    async def run_func(self, exe_id: int, func: Callable[[], Awaitable[Any]]) -> ExecutionResult:
    ...
    @abstractmethod
    def run(self, func: Callable[[], Awaitable[None]], num_workers: int = 1) -> list[ExecutionResult]:
