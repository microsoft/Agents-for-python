...
from microsoft_agents.hosting.testing.core.transport import AiohttpCallbackServer
from microsoft_agents.hosting.testing.core.transport.transcript import Transcript, Exchange
    ...
    async def test_handle_request_records_activity(self):
        ...
        async with server.listen() as transcript:
            ...
            mock_request.json = AsyncMock(
                return_value=activity.model_dump(by_alias=True, exclude_none=True)
            )
