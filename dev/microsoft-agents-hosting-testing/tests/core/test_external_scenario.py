...
from microsoft_agents.hosting.testing.core.scenario import Scenario, ScenarioConfig
...
class TestExternalScenarioRun:
    ...
    async def test_run_yields_factory(self):
        ...
        with patch(
            "microsoft_agents.hosting.testing.core.external_scenario.dotenv_values"
        ) as mock_dotenv, patch(
            "microsoft_agents.hosting.testing.core.external_scenario.load_configuration_from_env"
        ) as mock_load_config, patch(
            "microsoft_agents.hosting.testing.core.external_scenario.AiohttpCallbackServer"
        ) as mock_server_class, patch(
            "microsoft_agents.hosting.testing.core.external_scenario._AiohttpClientFactory"
    ...
    async def test_run_passes_service_endpoint_to_factory(self):
        ...
        with patch(
            ...
            async with scenario.run() as factory:
                assert (
                    factory._response_endpoint
                    == "http://localhost:9378/v3/conversations/"
                )
