...
from microsoft_agents.hosting.testing.core.agent_client import AgentClient, activities_from_ex
from microsoft_agents.hosting.testing.core.fluent import ActivityTemplate
from microsoft_agents.hosting.testing.core.transport import Transcript, Exchange, Sender
...
class TestActivitiesFromEx:
    ...
    def test_handles_exchanges_with_no_responses(self):
        ...
        exchange2 = Exchange(
            responses=[Activity(type=ActivityTypes.message, text="Only")]
        )
...
class TestAgentClientBuildActivity:
    ...
    def test_build_from_activity_preserves_activity(self):
        ...
        client = AgentClient(sender=sender)
        original = Activity(
            type=ActivityTypes.event, name="test-event", value={"key": "value"}
        )
    ...
    def test_build_applies_template_defaults(self):
        ...
        template = ActivityTemplate(
            channel_id="test-channel", locale="en-US", **{"from.id": "user-123"}
        )
        client = AgentClient(sender=sender, template=template)
...
class TestAgentClientSelectExpect:
    ...
    async def test_select_returns_select_instance(self):
        ...
        from microsoft_agents.hosting.testing.core import ActivitySelect
    ...
    async def test_expect_returns_activity_expect_instance(self):
        ...
        from microsoft_agents.hosting.testing.core import ActivityExpect
    ...
    async def test_ex_select_returns_select_with_exchanges(self):
        ...
        from microsoft_agents.hosting.testing.core import ExchangeSelect
    ...
    async def test_ex_expect_returns_exchange_expect_instance(self):
        ...
        from microsoft_agents.hosting.testing.core import ExchangeExpect
