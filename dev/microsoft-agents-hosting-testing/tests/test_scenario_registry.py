...
from microsoft_agents.hosting.testing.scenario_registry import (
    ScenarioEntry,
    ScenarioRegistry,
    scenario_registry,
    load_scenarios,
)
from microsoft_agents.hosting.testing.core import ExternalScenario
...
from microsoft_agents.hosting.testing.scenario_registry import scenario_registry
from microsoft_agents.hosting.testing.core import ExternalScenario
