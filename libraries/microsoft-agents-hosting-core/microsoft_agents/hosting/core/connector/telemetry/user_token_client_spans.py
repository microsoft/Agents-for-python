...
class GetUserToken(_UserTokenClientSpanWrapper):
    ...
    def __init__(self, connection_name: str, user_id: str, channel_id: str | None = None):
        """Initializes the GetUserToken span."""
        super().__init__(constants.SPAN_GET_USER_TOKEN,
...
class SignOut(_UserTokenClientSpanWrapper):
    ...
    def __init__(self, connection_name: str, user_id: str, channel_id: str | None = None):
        ...
        super().__init__(constants.SPAN_SIGN_OUT,
                         connection_name=connection_name,
                         user_id=user_id,
                         channel_id=channel_id)
...
class ExchangeToken(_UserTokenClientSpanWrapper):
    ...
    def __init__(self, connection_name: str, user_id: str, channel_id: str | None = None):
        ...
        super().__init__(constants.SPAN_EXCHANGE_TOKEN,
                         connection_name=connection_name,
                         user_id=user_id,
                        channel_id=channel_id)
...
class GetTokenOrSignInResource(_UserTokenClientSpanWrapper):
    ...
    def __init__(self, connection_name: str, user_id: str, channel_id: str | None = None):
        ...
        super().__init__(constants.SPAN_GET_TOKEN_OR_SIGN_IN_RESOURCE,
                         connection_name=connection_name,
                         user_id=user_id,
                         channel_id=channel_id)
...
class GetTokenStatus(_UserTokenClientSpanWrapper):
    ...
    def __init__(self, user_id: str, channel_id: str | None = None):
        ...
        super().__init__(constants.SPAN_GET_TOKEN_STATUS,
                         user_id=user_id,
                         channel_id=channel_id)
...
class GetAadTokens(_UserTokenClientSpanWrapper):
    ...
    def __init__(self, connection_name: str, user_id: str, channel_id: str | None = None):
        ...
        super().__init__(constants.SPAN_GET_AAD_TOKENS,
                         connection_name=connection_name,
                         user_id=user_id,
                         channel_id=channel_id)
