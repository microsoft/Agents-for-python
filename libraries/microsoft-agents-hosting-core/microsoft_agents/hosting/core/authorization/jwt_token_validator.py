...
#     def __init__(self, configuration: AgentAuthConfiguration | list[AgentAuthConfiguration]):
#         if isinstance(configuration, AgentAuthConfiguration):
#             configuration = [configuration]
#         self.configuration = configuration

#     def _validate_aud(self, aud: str) -> bool:
...
#             options={"verify_aud": False},
#         )
#         if not self._validate_aud(decoded_token["aud"]):
#             logger.error(f"Invalid audience: {decoded_token['aud']}", stack_info=True)
#             raise ValueError("Invalid audience.")
