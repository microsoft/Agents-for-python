...
- 🏗️ [Teams App Development](https://docs.microsoft.com/microsoftteams/platform/bots/what-are-bots)
- 🐛 [Report Issues](https://github.com/microsoft/Agents-for-python/issues)
- 💡 [Teams Sample Applications](https://github.com/microsoft/Agents-for-python/tree/main/test_samples/teams_agent)
- 📋 [Teams App Manifest Reference](https://docs.microsoft.com/microsoftteams/platform/resources/schema/manifest-schema)
