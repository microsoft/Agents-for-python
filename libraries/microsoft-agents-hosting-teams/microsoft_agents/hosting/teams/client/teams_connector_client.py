...
class TeamsConnectorClient:
    ...
    @classmethod
    async def get_team_member(cls, activity: Activity, team_id: str, user_id: str) -> TeamsChannelAccount:
    ...
    @classmethod
    async def get_member_internal(cls, activity: Activity, conversation_id: str, user_id: str):
    ...
    async def send_message_to_list_of_users(
            ...
            activity: Activity,
            tenant_id: str,
            members: list[TeamsMember]) -> TeamsBatchOperationResponse:
        pass # robrandao: TODO -> request
    ...
    async def get_operation_state(self, operation_id: str) -> BatchOperationStateResponse:
        pass # robrandao: TODO -> request
