...
class Activity(AgentsModel):
    ...
    :param type: Contains the activity type. Possible values include:
        ...
        'trace', 'handoff'
    :type type: str or ~msagents.protocols.models.ActivityTypes
    ...
    :type input_hint: str or ~msagents.protocols.models.InputHints
    ...
    :type suggested_actions: ~msagents.protocols.models.SuggestedActions
    :param attachments: Attachments
    :type attachments: list[~msagents.protocols.models.Attachment]
    :param entities: Represents the entities that were mentioned in the message.
    :type entities: list[~msagents.protocols.models.Entity]
    ...
    :type relates_to: ~msagents.protocols.models.ConversationReference
    ...
    :type code: str or ~msagents.protocols.models.EndOfConversationCodes
    ...
    :type importance: str or ~msagents.protocols.models.ActivityImportance
    ...
    :type delivery_mode: str or ~msagents.protocols.models.DeliveryModes
    ...
    :type text_highlights: list[~msagents.protocols.models.TextHighlight]
    :param semantic_action: An optional programmatic action accompanying this request
    :type semantic_action: ~msagents.protocols.models.SemanticAction
