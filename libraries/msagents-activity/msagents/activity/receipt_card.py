...
class ReceiptCard(AgentsModel):
    ...
    :type facts: list[~msagents.protocols.models.Fact]
    :param items: Array of Receipt Items
    :type items: list[~msagents.protocols.models.ReceiptItem]
    :param tap: This action will be activated when user taps on the card
    :type tap: ~msagents.protocols.models.CardAction
    ...
    :type buttons: list[~msagents.protocols.models.CardAction]
    """
