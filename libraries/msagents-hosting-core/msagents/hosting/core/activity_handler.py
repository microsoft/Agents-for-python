...
from msagents.activity import TurnContextProtocol
...
class ActivityHandler(Agent):
    ...
    async def on_turn(
        ...
        :type turn_context: :class:`msagents.builder.TurnContext`
    ...
    async def on_adaptive_card_invoke(
        ...
        :type invoke_value: :class:`msagents.activity.models.AdaptiveCardInvokeValue`
