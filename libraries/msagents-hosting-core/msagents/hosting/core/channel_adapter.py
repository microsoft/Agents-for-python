...
from msagents.activity import ChannelAdapterProtocol
...
class ChannelAdapter(ABC, ChannelAdapterProtocol):
    ...
    OAUTH_SCOPE_KEY = "msagents.Builder.ChannelAdapter.OAuthScope"
    ...
    async def continue_conversation(
        ...
        :param claims_identity: A :class:`msagents.authentication.ClaimsIdentity` for the conversation.
        :type claims_identity: :class:`msagents.authentication.ClaimsIdentity`
    ...
    async def create_conversation(
        ...
        :type conversation_parameters: :class:`msagents.activity.models.ConversationParameters`
        :param callback: The method to call for the resulting agent turn.
        ...
        """
        from msagents.activity import ActivityTypes
