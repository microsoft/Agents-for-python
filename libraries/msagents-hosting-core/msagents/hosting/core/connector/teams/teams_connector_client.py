...
from msagents.activity import Activity, ResourceResponse
from msagents.hosting.core.authorization import (
    AccessTokenProviderBase,
    AgentAuthConfiguration,
)
from msagents.hosting.core.connector.client import ConnectorClient

from msagents.activity import ConversationParameters
