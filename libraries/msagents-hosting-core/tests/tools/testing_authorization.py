...
from msagents.hosting.core.authorization.agent_auth_configuration import (
    AgentAuthConfiguration,
)
from msagents.hosting.core.authorization.claims_identity import ClaimsIdentity

from msagents.activity import TokenResponse
